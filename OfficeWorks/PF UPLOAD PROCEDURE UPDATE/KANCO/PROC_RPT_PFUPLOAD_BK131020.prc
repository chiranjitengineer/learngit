CREATE OR REPLACE PROCEDURE KANCO_WEB.PROC_RPT_PFUPLOAD_bk131020
(
...
--                            || '              FROM  GPSPAYSHEETDETAILS A, 
                            || '             FROM ( 
                                                SELECT COMPANYCODE, DIVISIONCODE , WORKERSERIAL, TOKENNO,SUM(GROSSWAGES) GROSSWAGES,SUM(PF_GROSS) PF_GROSS, SUM(PF_E) PF_E
                                                FROM (  
                                                SELECT COMPANYCODE, DIVISIONCODE , WORKERSERIAL, TOKENNO,GROSSWAGES,PF_GROSS, PF_E   
                                                ...
                                                AND PF_E>0  
                                                UNION ALL
                                                SELECT A.COMPANYCODE, A.DIVISIONCODE , A.WORKERSERIAL, B.TOKENNO,A.NETLEAVEAMOUNT GROSSWAGES, A.PFGROSS ,  A.PFAMOUNT PF_E    
