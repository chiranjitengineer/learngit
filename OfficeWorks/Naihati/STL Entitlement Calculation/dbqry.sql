...
INSERT INTO WPSSTLENTITLEMENTCALCDETAILS
 ...
 SELECT COMPANYCODE, DIVISIONCODE, WORKERSERIAL, TOKENNO, WORKERCATEGORYCODE, '2020'  FROMYEAR, '2019-2020' YEARCODE,
 ...
 STNDHRS STANDARDSTLHOURS, 0 ADJUSTEDHOURS, 1920 APPLICABLESTANDHOURS, ENT_DAYS STLDAYS, ENT_DAYS*8 STLHOURS, PREV_ENT_STLDAYS STLDAYS_BF,
...
SELECT
 ...
 0 PREV_ENT_STLDAYS,
     CASE WHEN B.TERMINATIONDATE IS  NULL THEN
         CASE WHEN SUM(ELIGIBLE_HRS) >=1920 THEN ROUND(SUM(FEWORKINGDAYS)/20,0) ELSE 0 END
          WHEN B.TERMINATIONDATE BETWEEN '01-JAN-20'  AND '31-DEC-20' AND SUM(ELIGIBLE_HRS) >= 1920-((TO_NUMBER(TO_CHAR(TERMINATIONDATE,'MM'))-TO_NUMBER(TO_CHAR(TO_DATE('01-JAN-20','DD/MM/YYYY'),'MM')-1))*160)  THEN
          ROUND(SUM(FEWORKINGDAYS)/20,0)
          ELSE 0
     END
     ENT_DAYS
 , CASE WHEN B.TERMINATIONDATE IS  NULL  THEN 1920
        WHEN B.TERMINATIONDATE BETWEEN '01-JAN-20'  AND '31-DEC-20' THEN
        ((TO_NUMBER(TO_CHAR(TERMINATIONDATE,'MM'))-TO_NUMBER(TO_CHAR(TO_DATE('01-JAN-20','DD/MM/YYYY'),'MM')-1))*160)
        ELSE 0 END
        STNDHRS
 FROM (
 ...
 INSERT INTO WPSSTLTRANSACTION
  ...
  SELECT 'NJ0001' COMPANYCODE,'0002' DIVISIONCODE,WORKERSERIAL,TOKENNO,'2020','2019-2020' YEARCODE, 
    ...
    WHERE COMPANYCODE = 'NJ0001' AND DIVISIONCODE = '0002' 
      ...
      AND FORTNIGHTSTARTDATE = '01-JAN-21' AND FORTNIGHTENDDATE = '15-JAN-21' 
