CREATE OR REPLACE PROCEDURE DHAMAI.PROC_RPT_WAGESSUMMARY_DHAMAI
(
...
BEGIN
    LV_RUNDATE :='' ;
    DELETE FROM GTT_WAGESSUMMARY_DHAMAI;  
    ...
    LV_SQLSTR :=   'INSERT INTO  GTT_WAGESSUMMARY_DHAMAI(ATTNBOOKCODE, ATTN_ALLOW, CATEGORYCODE, CLUSTERCODE, COINBF, COINCF,'||CHR(10)
...
||     '    ST_PER_PAY, TEMP_DED, CYCLE_ALLOW, CHARGE_ALLOW, SPEC_ALLOW,  TOKENNO, WASHING_ALLW, WORKERSERIAL,EX1,EX2,EX3)'||CHR(10)
||     '    SELECT  ATTNBOOKCODE, ATTN_ALLOW, CATEGORYCODE, CLUSTERCODE, COINBF, COINCF,'||CHR(10)
||     '    DA, DED_ELEC, DED_ITAX, DED_LIC, DED_UNION, DED_WELFARE,EMPLOYEENAME,  EXTRA_ALLOW, FACT_ALOW, GROSSDEDN, GROSSWAGES, '||CHR(10)
||     '    GTR_BASIC, HAZIRA, HOLIDAY_WAGE, INCENTIVE, LINT_PF, LOAN_ADVCO, LOAN_ADVFT, LOAN_ADVGN, LOAN_ADVOP, '||CHR(10)
||     '    LOAN_MD, LOAN_PF, LPG_ALLOW, MDP_WAGES, MED_ALLOW, MISC_ALLOW, MTR_BASIC, NETSALARY, NIGHT_ALLOW,'||CHR(10)
||     '    NONPF_ALLOW, OTHER_DED, OT_AMOUNT, PERPAY_ALLOW ,PF_E, PF_GROSS, POP, RAT_DED, SICK_ALLOW, SPRAY_ALLOW,'||CHR(10)
||     '    ST_PER_PAY, TEMP_DED, CYCLE_ALLOW, CHARGE_ALLOW, SPEC_ALLOW,  TOKENNO, WASHING_ALLW, WORKERSERIAL ,'''||P_FROMDATE||'''||'' to ''||'''||P_TODATE||''','''||LV_CLUSTERCODE||''','''||LV_CATEGORYCODE||''' '||CHR(10)
||     '    FROM '||CHR(10)
||     '                    ( '||CHR(10)
...
||     '            NVL(SUM(NVL(CYCLE_ALLOW,0)),0)   CYCLE_ALLOW, '||CHR(10)
||     '            NVL(SUM(NVL(CHARGE_ALLOW ,0)),0)    CHARGE_ALLOW ,  '||CHR(10)
||     '            NVL(SUM(NVL(SPEC_ALLOW ,0)),0)  SPEC_ALLOW    '||CHR(10)
...
UPDATE GTT_WAGESSUMMARY_DHAMAI SET
