DROP PROCEDURE NJMCL_WEB.PRCWPS_WAGES_PROCESS;

CREATE OR REPLACE PROCEDURE NJMCL_WEB."PRCWPS_WAGES_PROCESS" (P_PROCESSTYPE varchar2, P_COMPCODE varchar2, P_DIVCODE varchar2, P_YEARCODE varchar2,
                                                  P_USERNAME VARCHAR2,   
                                                  P_FNSTDT Varchar2, 
                                                  P_FNENDT Varchar2,
