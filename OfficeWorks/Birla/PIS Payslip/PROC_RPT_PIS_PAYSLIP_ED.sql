...
LV_SQLSTR := LV_SQLSTR || '        CATEGORYCODE, GRADECODE, WORKERSERIAL, TOKENNO ' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '        FROM GTT_PISPAYSLIP_ED_BIRLA' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '    ) A, PISEMPLOYEEMASTER B' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '    WHERE A.COMPANYCODE=B.COMPANYCODE' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '    AND A.DIVISIONCODE=B.DIVISIONCODE' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '    AND A.TOKENNO=B.TOKENNO' || CHR(10);
LV_SQLSTR := LV_SQLSTR || ')' || CHR(10);
...
LV_SQLSTR := LV_SQLSTR || 'DECODE(COMPONENTCODE,''AVL'',''AVL'',''BAL'',''BAL'',''ERN'',''ERN'',''OPBAL'',''OP.BAL'') COMPONENTSHORTNAME,' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '1 PHASE, ' || CHR(10);
LV_SQLSTR := LV_SQLSTR || 'DECODE(COMPONENTCODE,''ERN'',1,''AVL'',2,''BAL'',3,''OPBAL'',0) CALCULATIONINDEX,''LEAVE'' COMPONENTTYPE FROM ' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '(' || CHR(10);
...
--LV_SQLSTR := LV_SQLSTR || '    A.WORKERSERIAL,A.TOKENNO,A.LEAVECODE,A.LV_TAKEN AVL,A.LV_BAL BAL,NVL(ENTITLEMENTS,0) ERN,(A.LV_BAL+A.LV_TAKEN-NVL(ENTITLEMENTS,0)) OPBAL FROM' || CHR(10);
--LV_SQLSTR := LV_SQLSTR || '    A.WORKERSERIAL,A.TOKENNO,A.LEAVECODE,A.LV_TAKEN AVL,A.LV_BAL BAL,' || CHR(10);
--LV_SQLSTR := LV_SQLSTR || '    CASE WHEN  (A.LV_BAL+A.LV_TAKEN-NVL(ENTITLEMENTS,0)) > 0 THEN NVL(ENTITLEMENTS,0)  ELSE (A.LV_BAL+A.LV_TAKEN) END  ERN,' || CHR(10);
--LV_SQLSTR := LV_SQLSTR || '    CASE WHEN  (A.LV_BAL+A.LV_TAKEN-NVL(ENTITLEMENTS,0)) > 0 THEN (A.LV_BAL+A.LV_TAKEN-NVL(ENTITLEMENTS,0)) ELSE 0 END OPBAL FROM' || CHR(10);


LV_SQLSTR := LV_SQLSTR || '     A.WORKERSERIAL,A.TOKENNO,A.LEAVECODE,NVL(ENTITLEMENTS,0) + NVL(B.OPBAL,0) -  NVL(A.LV_BAL,0) AVL,A.LV_BAL BAL,' || CHR(10);    
LV_SQLSTR := LV_SQLSTR || '     NVL(ENTITLEMENTS,0) ERN,A.LV_TAKEN, B.OPBAL FROM' || CHR(10);
...
LV_SQLSTR := LV_SQLSTR || '         SELECT COMPANYCODE, DIVISIONCODE,YEARCODE,NULL UNITCODE,CATEGORYCODE,GRADECODE , TOKENNO, WORKERSERIAL,LEAVECODE, ' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '         SUM(DECODE(TRANSACTIONTYPE,''ENT'',NOOFDAYS,0)) ENTITLEMENTS,SUM(DECODE(TRANSACTIONTYPE,''BF'',NOOFDAYS,0)) OPBAL' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '         FROM  PISLEAVETRANSACTION ' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '         WHERE 1=1 ' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '         AND YEARCODE='''||P_YEARCODE||''' ' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '         AND YEARMONTH <= '||P_YEARMONTH||' ' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '         GROUP BY COMPANYCODE, DIVISIONCODE,YEARCODE,CATEGORYCODE,GRADECODE , TOKENNO, WORKERSERIAL,LEAVECODE ' || CHR(10);
...
LV_SQLSTR := LV_SQLSTR || '(' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '    COMPONENTVALUE' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '    FOR COMPONENTCODE IN (AVL,BAL,ERN,OPBAL)' || CHR(10);
LV_SQLSTR := LV_SQLSTR || ')' || CHR(10);
