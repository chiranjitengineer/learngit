<%@ Page Title="" Language="vb" ValidateRequest="false" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="AcPaymentAdvanceDirect.aspx.vb" Inherits="swterp.AcPaymentAdvanceDirect" %>
<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" runat="server">
         ...
         $(function () {
             $('#<%=txtNARRATION.ClientID%>').autocomplete({
                 ...
                 source: function (request, response) {
                     $.ajax({
                         url: "AcPaymentAdvanceDirect.aspx/GetCompletionList",
    ...
    <script type="text/javascript">
        ...
        function GetPartyDtlsData() {
            ...
            {
                type: "POST",
                url: "AcPaymentAdvanceDirect.aspx/fetchPartyDtls",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        function GenerateReferenceNo() {
            ...
            {
                type: "POST",
                url: "AcPaymentAdvanceDirect.aspx/getReferenceNo",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                asycn: false,
        ...
        function GetOrderDtlsData() {
            ...
            {
                type: "POST",
                url: "AcPaymentAdvanceDirect.aspx/fetchOrderDtls",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                asycn: false,
        ...
        function GetCashBankLedgerData() {
            ...
            {
                type: "POST",
                url: "AcPaymentAdvanceDirect.aspx/fetchLiabilityDtls",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function GetChequeNo(varCashBankCode, varBookSlNo) {
            var strCompCode = document.getElementById('<%=txtCOMPCODE.ClientID%>').value;
             ...
             {
                 type: "POST",
                 url: "AcPaymentAdvanceDirect.aspx/fetchChequeNo",
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
         ...
         function GetVoucherHeaderData() {
            ...
            {
                type: "POST",
                url: "AcPaymentAdvanceDirect.aspx/fetchVoucherHeaderData",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function FetchTDSGridData() {
            ...
            {
                type: "POST",
                url: "AcPaymentAdvanceDirect.aspx/getTDSGridData",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        function FetchTDSGridBySysVoucherNo() {
            ...
            {
                type: "POST",
                url: "AcPaymentAdvanceDirect.aspx/getTDSGridBySysVoucherNo",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
                data: JSON.stringify({ strSysVoucherNo: varSysVoucherNo, strOperationMode: varOperationMode, strAcCode: varAcCode, strSysVoucherDt: varSysVoucherDt, strGroupType: varGroupType }),
                success: function (res) {
                    part = res.d;
                    var data = JSON.parse(part);
                    $("div").find("#gridTDS").handsontable('loadData', data);
        ...
        function fn_calcTDSAmount(rowIndex) {
            ...
            {
                type: "POST",
                url: "AcPaymentAdvanceDirect.aspx/calcTDSAmount",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
                data: JSON.stringify({
                    strcompcode: varcompcode, strdivcode: vardivcode, stryearcode: varyearcode,
                    straccode: varaccode, strtdscode: vartdscode, strTDSOnAmt: varTDSOnAmt
                }),
                success: function (response) {
                    var str1 = (response.d);
                    var strDataArr = new Array();
