...
(
    ...
    P_LOGOPATH               VARCHAR2 DEFAULT NULL 
)
AS
...
BEGIN
    ...
    IF P_LOGOPATH IS not NULL THEN
    
        SELECT P_LOGOPATH||LOGONAME INTO LV_LOGOPATH FROM MODULEWISELOGO WHERE MODULE='SALES' AND ROWNUM=1;
    
    ELSE
        SELECT 'D:\swterp\\LOGO\LOGO_BIRLA.jpg' INTO LV_LOGOPATH FROM MODULEWISELOGO WHERE MODULE='SALES' AND ROWNUM=1;
