INSERT INTO GBL_PFLOANBLNC 
 ...
 CASE WHEN Z.DEDUCTIONSTARTDATE > TO_DATE('21/10/2020','DD/MM/YYYY') THEN 0 ELSE 
 ...
 FROM (  
         ...
         WHERE A.COMPANYCODE = 'JT0069' AND A.DIVISIONCODE = '0002' AND A.COMPANYCODE=B.COMPANYCODE AND A.DIVISIONCODE=B.DIVISIONCODE AND A.PFNO = B.PFNO AND A.LOANDATE = B.LOANDATE  
     ...
     (  
        ...
        FROM PFLOANTRANSACTION M, ( SELECT COMPANYCODE,DIVISIONCODE,PFNO, MAX(LOANDATE) LOANDATE  
                                  FROM PFLOANTRANSACTION  
                                  WHERE LOANDATE <= TO_DATE('21/10/2020','DD/MM/YYYY')  
                                  GROUP BY COMPANYCODE,DIVISIONCODE,PFNO  
                                ) N   
