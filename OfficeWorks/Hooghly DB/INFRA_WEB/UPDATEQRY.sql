...
Insert into SYS_PARAMETER
 ...
 Values
   ...
   'ORDERNO,ORDERDATE,PRIVATEMARKPO,MILLGRDCODEPO,MKTGRDCODEPO,CROPYEARASPERPO,BALETYPE,ORDERSERIALNO', 'JUTE', '0002', 
    TO_DATE('02/28/2015 22:48:42', 'MM/DD/YYYY HH24:MI:SS'), '4', '0022', 'SWT', 'SWT TO SET');

Insert into SYS_PARAMETER
   (PARAMETER_NAME, PARAMETER_DESC, PARAMETER_VALUE, PROJECTNAME, COMPANYCODE, LASTMODIFIED, SYSROWID, DIVISIONCODE, USERNAME, ALLOW_CHANGE_FROM_INTERFACE)
 Values
   ('ARRIVAL MASTER COLUMN TO BE CHANGE', 'ARRIVAL MASTER COLUMN TO BE CHANGE', 
   'ORDERNO,ORDERDATE,BROKERCODE,REGIONCODE,BOOKINGSTATION,CONTRACTNO,CONTRACTDATE ', 'JUTE', '0002', 
    TO_DATE('02/28/2015 22:48:42', 'MM/DD/YYYY HH24:MI:SS'), '4', '0022', 'SWT', 'SWT TO SET');
COMMIT;
...
Insert into SYS_PARAMETER
   (PARAMETER_NAME, PARAMETER_DESC, PARAMETER_VALUE, PROJECTNAME, COMPANYCODE, LASTMODIFIED, SYSROWID, DIVISIONCODE, USERNAME, ALLOW_CHANGE_FROM_INTERFACE)
 Values
   ('ARRIVAL DUMMY PO PREFIX', 'ARRIVAL DUMMY PO PREFIX', 'DUMMY', 'JUTE', '0002', 
   TO_DATE('02/28/2015 22:48:42', 'MM/DD/YYYY HH24:MI:SS'), '4', '0022', 'SWT', 
    'SWT TO SET');
COMMIT;
...
Insert into MENUMASTER_RND
 ...
 Values
   ('01020221', NULL, 'Arrival Details without PO', 'TRANSACTIONS', NULL, 
    NULL, NULL, 'Y', 'Y', 'Y', 
    'N', 'N', 'Y', 'JUTE', NULL, 
    NULL, '''0022''', NULL, 'JUTE/Pages/Transaction/pgRawJuteArrival_without_PO.aspx', NULL, 
...
Insert into MENUMASTER_RND
 ...
 Values
   ('0102020105', NULL, 'Purchase Order (Dummy)', 'TRANSACTIONS', 'PURCHASE ORDER DUMMY', 
    NULL, NULL, 'Y', 'Y', 'Y', 
    'N', 'N', 'Y', 'JUTE', NULL, 
    NULL, '''0022''', NULL, 'JUTE/Pages/Transaction/pgJUTEPURCHASEORDER_BS.aspx', NULL, 
...
Insert into SYS_PARAMETER
 ...
 Values
   ('ARRIVAL DETAILS COLUMN TO BE CHANGE', 'ARRIVAL DETAILS COLUMN TO BE CHANGE', 'ORDERNO,ORDERDATE,PRIVATEMARKPO,MILLGRDCODEPO,MKTGRDCODEPO,CROPYEARASPERPO,BALETYPE,ORDERSERIALNO', 'JUTE', 'LJ0054', 
    TO_DATE('02/28/2015 22:48:42', 'MM/DD/YYYY HH24:MI:SS'), '4', '0002', 'SWT', 'SWT TO SET');
...
Insert into SYS_PARAMETER
 ...
 Values
   ('ARRIVAL DUMMY PO PREFIX', 'ARRIVAL DUMMY PO PREFIX', 'DUMMY', 'JUTE', 
    'LJ0054', TO_DATE('02/28/2015 22:48:42', 'MM/DD/YYYY HH24:MI:SS'), '4', '0002', 'SWT', 
    'SWT TO SET');
COMMIT;
