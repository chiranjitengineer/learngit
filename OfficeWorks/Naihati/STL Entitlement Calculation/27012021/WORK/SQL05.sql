INSERT INTO WPSSTLENTITLEMENTCALCDETAILS
 ...
 TRANSACTIONTYPE, ADDLESS, USERNAME, LASTMODIFIED, SYSROWID,GRACEDAYS
 )
 ...
 'ENTITLEMENT' TRANSACTIONTYPE, 'ADD' ADDLESS, 'SWT' USERNAME, SYSDATE LASTMODIFIED, WORKERSERIAL||'-'||TO_CHAR(SYSDATE,'YYYYMMDDHHMISS') SYSROWID,GRACEDAYS
 FROM (
SELECT
