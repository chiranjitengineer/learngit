DROP PROCEDURE NJMCL_WEB.PRCWPS_HOLIDAY_PROCESS_BKP;

CREATE OR REPLACE PROCEDURE NJMCL_WEB."PRCWPS_HOLIDAY_PROCESS_BKP" ( p_CompCode varchar2, p_DivisionCode varchar2, p_YearCode varchar2, 
