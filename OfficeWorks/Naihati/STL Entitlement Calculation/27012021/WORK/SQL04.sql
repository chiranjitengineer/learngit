INSERT INTO WPSSTLENTITLEMENTCALCDETAILS
 ...
 STNDDAYS*8 STANDARDSTLHOURS, 0 ADJUSTEDHOURS, 1880 APPLICABLESTANDHOURS, ENT_DAYS STLDAYS, ENT_DAYS*8 STLHOURS, PREV_ENT_STLDAYS STLDAYS_BF,
 ...
 SUM(ELIGIBLE_DAYS) ELIGIBLE_DAYS, sum(NVL(GRACEDAYS,0)) GRACEDAYS,
 0 PREV_ENT_STLDAYS,
     CASE WHEN B.TERMINATIONDATE IS  NULL THEN
         CASE WHEN SUM(ELIGIBLE_DAYS+NVL(GRACEDAYS,0)) >=240 THEN ROUND(SUM(FEWORKINGDAYS)/20,0) ELSE 0 END
          WHEN B.TERMINATIONDATE BETWEEN '01-JAN-21'  AND '31-DEC-21' AND SUM(ELIGIBLE_DAYS+NVL(GRACEDAYS,0)) >= 240-((TO_NUMBER(TO_CHAR(TERMINATIONDATE,'MM'))-TO_NUMBER(TO_CHAR(TO_DATE('01-JAN-21','DD/MM/YYYY'),'MM')-1))*20)  THEN
