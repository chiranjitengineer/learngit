CREATE OR REPLACE PROCEDURE PROC_SALESOTHERSBILLPRINTGST 
(
...
begin
    ...
    lv_sqlstr :=   'insert into gtt_salesotherbillprintgst ('|| chr(10)
                || '    SALEBILLNO, SALEBILLDATE, EXCISEINVNO, EXCISEINVDATE, PROFORMAINVNO, PROFORMAINVDATE, SAUDANO, SAUDADATE, '|| chr(10)
                || '    BUYERORDERNO, BUYERORDERDATE, BROKERCODE, BROKERNAME, BUYERCODE, BUYERNAME, TRANSPORTERCODE, PARTYNAME, '|| chr(10)
                || '    ADDRESSNAMEBILL, ADDRESSBILL, PINBILL, STATEBILL, GSTNNOBILL, ADDRESSNAMESHIP, ADDRESSSHIP, PINSHIP, '|| chr(10)
                || '    STATESHIP, GSTNNOSHIP, DESTINATION, VEHICLENO, VESSELORFLIGHT, VESSELFLIGHTNO, CNOTENO, CNOTEDATE, '|| chr(10)
                || '    CHALLANNO, CHANNELCODE, BILLSERIALNO, QUALITYCODE, HSNCODE, QUALITYMANUALDESC, PACKINGCODE, PACKINGNAME, '|| chr(10)
                || '    NOOFPACKINGUNIT, UORCODE, UORNAME, MEASURECODE, TOTALQUANTITY, TOTALWEIGHT, PACKSHEETWEIGHT, GROSSWEIGHT, '|| chr(10)
                || '    INDIANRATE, TOTALINDIANAMOUNT, GROSSAMOUNTINR, AMTINWORDS, CHARGEDATA, SRL, TEXT, BANKCODE, BANKNAME, '|| chr(10)
                || '    BANKADDRESS, ACNO, IFCSCODE, COMPANYNAME, COMPANYADDRESS, COMPANYADDRESS1, COMPANYADDRESS2, PANNO, '|| chr(10)
                || '    COMPANYEMAIL, DIVISIONNAME, GSTNNO, GSTSTATECODE, LOGOPATH, EX1, EX2, EX3, EX4, EX5,'|| chr(10)
                || '    EX6, EX7, EX8, EX9, EX10'|| chr(10)
                || ')'|| chr(10)
                ...
                || '       C.COMPANYHOPHONE1 EX6,''FAX : ''||COMPANYFAX EX7,''COUNTRY : ''|| C.COMPANYCOUNTRY EX8,''STATE : ''||C.COMPANYSTATE ||''   STATE CODE : ''||D.GSTSTATECODE EX9, NULL EX10  '|| chr(10)
