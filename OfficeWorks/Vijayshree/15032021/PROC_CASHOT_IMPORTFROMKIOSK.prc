...
IF LV_KIOSK_DBLINK IS NOT NULL THEN
    ...
    ELSE
        ...
        LV_SQL := LV_SQL || ' AND COMPONENTCODE=''CASHOT_AMT'''||CHR(10);
        ...
        LV_SQL := LV_SQL || ' ''CASHOT_AMT'' COMPONENTCODE,NETPAY COMPONENTAMOUNT,NETPAY ACTUALAMOUNT,NULL REFERENCE_FNEDATE,PAYMENTDATE PAIDON,''UNREALIZED'' TRANTYPE, '||CHR(10);
