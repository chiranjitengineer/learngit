...
LV_SQLSTR := LV_SQLSTR || 'SELECT E.UNITCODE, E.TOKENNO, E.EMPLOYEENAME, E.GRADECODE, E.CATEGORYCODE,'||LV_ERN_COMP||','||LV_RIM_COMP||','||LV_DED_COMP||' FROM ' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '(' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '    SELECT TOKENNO,'||LV_ERN_COMP_SUM|| CHR(10);
...
LV_SQLSTR := LV_SQLSTR || '    GROUP BY TOKENNO' || CHR(10);
LV_SQLSTR := LV_SQLSTR || ') A,' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '(' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '    SELECT * FROM ' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '    (' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '        ( ' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '            SELECT TOKENNO, COMPONENTCODE, PAIDAMOUNT' || CHR(10);
...
LV_SQLSTR := LV_SQLSTR || '(' || CHR(10);
LV_SQLSTR := LV_SQLSTR || '    SELECT TOKENNO,'||LV_DED_COMP_SUM|| CHR(10);
...
( 
    ...
    ORDER BY UNITCODE, CATEGORYCODE, TOKENNO
)
LOOP
    ...
    --START TOP HEADER
        ...
        LV_EXCELVALUES := 'COMPONENT REGISTER WITH REIMBURSEMENT PERIOD FROM '||TO_CHAR(TO_DATE(LV_YEARMONTH_FROM,'YYYYMM'),'MON-YYYY')||' TO '||TO_CHAR(TO_DATE(LV_YEARMONTH_FROM,'YYYYMM'),'MON-YYYY');    
    ...
    LV_SQLSTR := 'SELECT ''^''||UNITCODE||''^''||TOKENNO||''^''||EMPLOYEENAME||''^''||GRADECODE||''^''||CATEGORYCODE';
