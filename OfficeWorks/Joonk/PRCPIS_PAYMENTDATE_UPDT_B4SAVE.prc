    ...
    LV_RESULT:='#SUCCESS#';
        ...
        IF LV_MASTER.OPERATIONMODE ='A' THEN
            ...
            IF LV_CNT = 0 THEN
                ...
                VALUES ('[PAYMENT DATE UPDATE FOR THE MONTH OF ' || TO_CHAR(TO_DATE(LV_MASTER.YEARMONTH,'YYYYMM'),'MON-YYYY') || ' Dated : ' || LV_MASTER.PAYMENTDATE || ']');
            ELSE
                UPDATE SYS_GBL_PROCOUTPUT_INFO
                SET SYS_SAVE_INFO = NVL(SYS_SAVE_INFO,'') || ('[PAYMENT DATE UPDATE FOR THE MONTH OF ' || TO_CHAR(TO_DATE(LV_MASTER.YEARMONTH,'YYYYMM'),'MON-YYYY') || ' Dated : ' || LV_MASTER.PAYMENTDATE || ']');
            END IF;   
