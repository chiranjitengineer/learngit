...
--    END IF;
    ...
    IF P_MODULE = 'WPS' THEN
        ...
        LV_SQL := ' DELETE FROM ' || LV_UNREALIZEDTABLE ||CHR(10) 
                ...
                ||' AND COMPONENTCODE = '''||P_UPD_FRM_COMPONENT || '''' ||CHR(10) 
        ...
        LV_REMARKS := P_MODULE||' REALIZED ' || P_UPD_FRM_COMPONENT || ' DATA DELETE';
        ...
        LV_REMARKS := P_UPD_FRM_COMPONENT || ' DATA TRANSFER TO ' || LV_UNREALIZEDTABLE;
        INSERT INTO WPS_ERROR_LOG(PROC_NAME,ORA_ERROR_MESSG,ERROR_QUERY,PAR_VALUES,FORTNIGHTSTARTDATE, FORTNIGHTENDDATE, REMARKS ) VALUES( LV_PROCNAME,'',LV_SQL,LV_PARVALUES, LV_FN_STDT, LV_FN_ENDT, LV_REMARKS);
...
LV_SQL :=  'INSERT INTO ' || LV_UNREALIZEDTABLE ||CHR(10)
        ...
        || ''''||P_UPD_FRM_COMPONENT||''' COMPONENTCODE,-1*'||P_UPD_FRM_COMPONENT||' COMPONENTAMOUNT,-1*'||P_UPD_FRM_COMPONENT||' ACTUALAMOUNT,FORTNIGHTENDDATE REFERENCE_FNEDATE, '||CHR(10)
