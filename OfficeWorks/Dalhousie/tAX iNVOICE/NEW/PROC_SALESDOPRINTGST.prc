...
begin
    ...
    lv_sqlstr :=   'insert into gtt_salesdoprintgst(SALEBILLNO, SALEBILLDATE, EXCISEINVNO, EXCISEINVDATE, PROFORMAINVNO, PROFORMAINVDATE, '|| chr(10)
                ...
                || 'GSTSTATECODE, LOGOPATH, EX1, EX2, EX3, EX4, EX5, EX6, EX7, EX8, EX9)'|| chr(10)
                ...
                || '       S.PROFORMASERIALNO BILLSERIALNO, S.QUALITYCODE, H.HSNCODE,''[''|| S.QUALITYCODE ||''] ''||CHR(10)||  S.QUALITYMANUALDESC||CHR(10)||S.MARKS QUALITYMANUALDESC, S.PACKINGCODE, S.PACKINGNAME, S.NOOFPACKINGUNIT, S.UORCODE,   '|| chr(10)
                ...
                || '       C.COMPANYHOPHONE1 EX6, C.COMPANYFAX EX7, C.COMPANYCOUNTRY EX8, C.COMPANYSTATE EX9'||CHR(10)
                ...
                || '     ) CH,  '|| chr(10)
                || '     (  '|| chr(10)
                || '        SELECT 1 SRL, ''Original for Buyer'' TEXT FROM DUAL  '|| chr(10)
               || '        UNION ALL  '|| chr(10)
