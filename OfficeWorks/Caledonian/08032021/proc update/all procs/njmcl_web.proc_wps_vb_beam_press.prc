DROP PROCEDURE NJMCL_WEB.PROC_WPS_VB_BEAM_PRESS;

CREATE OR REPLACE PROCEDURE NJMCL_WEB.PROC_WPS_VB_BEAM_PRESS( P_COMPCODE VARCHAR2, P_DIVCODE VARCHAR2, P_YEARCODE VARCHAR2,P_FN_STDT VARCHAR2, P_FN_ENDT VARCHAR2, P_1ST_WK_ENDT VARCHAR2 DEFAULT NULL, 
