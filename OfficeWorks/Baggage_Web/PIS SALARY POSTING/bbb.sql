SELECT * FROM VW_PISCOMPONENTLEDGERMAPPING
...
SELECT D.COMPANYCODE,D.DIVISIONCODE, 
       ...
       CASE                                                
            ...
            ELSE 'DR' 
        END AS DRCR, 
       FN_PISSALARY_COMP_AMT(C.COMPANYCODE,C.DIVISIONCODE,'SALARY PROCESS',C.COMPONENTCODE, '202010' , '')  AMOUNT, 
...
SELECT SUM(NVL(LOAN_PF,0)) 
 FROM PISPAYTRANSACTION A
 WHERE COMPANYCODE = '0001' AND DIVISIONCODE = '001' 
   AND YEARMONTH = '202010' 

SELECT SUM(NVL(LOAN_VCLN,0)) 
 FROM PISPAYTRANSACTION A
 WHERE COMPANYCODE = '0001' AND DIVISIONCODE = '001' 
   AND YEARMONTH = '202010' 

SELECT SUM(NVL(LOAN_MGLN,0)) 
 FROM PISPAYTRANSACTION A
 WHERE COMPANYCODE = '0001' AND DIVISIONCODE = '001' 
   AND YEARMONTH = '202010' 
...
SELECT SUM(NVL(LOAN_SADV,0)) 
 FROM PISPAYTRANSACTION A
 WHERE COMPANYCODE = '0001' AND DIVISIONCODE = '001' 
   AND YEARMONTH = '202010' 

SELECT SUM(NVL(LOAN_PRLN,0)) 
 FROM PISPAYTRANSACTION A
 WHERE COMPANYCODE = '0001' AND DIVISIONCODE = '001' 
   AND YEARMONTH = '202010' 

SELECT SUM(NVL(LOAN_EDLN,0)) 
 FROM PISPAYTRANSACTION A
 WHERE COMPANYCODE = '0001' AND DIVISIONCODE = '001' 
   AND YEARMONTH = '202010' 

SELECT SUM(NVL(LOAN_OTLN,0)) 
 FROM PISPAYTRANSACTION A
 WHERE COMPANYCODE = '0001' AND DIVISIONCODE = '001' 
   AND YEARMONTH = '202010'