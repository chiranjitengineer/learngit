...
INSERT INTO GTT_PISREIMBURSEMENT 
         ...
         SELECT A.COMPANYCODE, A.DIVISIONCODE,'2020-2021' YEARCODE,'2020-2021' FORYEARCODE,'202008' YEARMONTH,A.WORKERSERIAL,A.TOKENNO,
         A.EMPLOYEENAME,TO_CHAR(A.DATEOFJOIN,'DD/MM/YYYY') DATEOFJOIN , A.UNITCODE,A.CATEGORYCODE, A.GRADECODE, 'LTA' COMPONENTCODE, 
         B.COMPONENTAMOUNT  COMPONENTAMOUNT,'LTA'   TRANSACTIONTYPE,    'ADD' ADDLESS, 
         ...
         NVL(D3.PREVIOUSYRTAKEN,0)  PREVIOUSYRTAKEN,(B.COMPONENTAMOUNT + (NVL(C.LASTCOMPONENTAMOUNT,0)-NVL(D3.PREVIOUSYRTAKEN,0)) -NVL(D2.PAIDAMOUNT,0)) TOTALDUE,DECODE('','A', DECODE('LTA', 'BONUS', B.COMPONENTAMOUNT ,0),NVL(D.PAIDAMOUNT,0))  AMOUNTCLAIMCURRENT,NVL(D4.AMOUNTCLAIMPREVIOUS,0) AMOUNTCLAIMPREVIOUS,
...
--                  )-- TOKENNO WITH BASIC, YEARMONTH FOR LAST YEAR
                    ...
                    WHERE 1=1     
                    AND P.TRANSACTIONTYPE='ENTITLEMENT'     
                    AND P.YEARCODE =  (SUBSTR('2020-2021',1,4) -1)||'-'||(SUBSTR('2020-2021',-4)-1)   
                    AND COMPONENTCODE='LTA'    
                    AND COMPANYCODE='0001'
                    AND DIVISIONCODE='001'
              ) A,-- LAST YEAR COMPONENT AMOUNT 
